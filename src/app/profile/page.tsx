...
export default function Profile() {
    ...
    return (
        <div className="container m-auto py-10 mb-10">
            <div className="mt-10 container m-auto flex flex-wrap gap-10 lg:justify-start sm: justify-center">
                <div className="border border-gray-300 h-64 rounded-lg divide-y divide-gray-300 lg:w-60 sm: w-[350px]">
                    <div className="flex items-center gap-3 p-3">
                        <Image src="/images/userImage.webp" width={50} height={50} alt="foto do usuário" />
                        <h2 className="font-bold lg:block text-2xl">John Doe</h2>
                    </div>
                ...
                <div>
                    {profile && <div>
                        ...
                        <div className="mt-5 flex flex-col gap-3">
                            <h6 className="lg:text-sm sm: text-xs">Nome: John Doe</h6>
                            <h6 className="lg:text-sm sm: text-xs">Endereço: Rua Lorem Ipsum</h6>
                            <h6 className="lg:text-sm sm: text-xs">Telefone: 21 96578985</h6>
                            <button className="mt-5 flex gap-3 justify-center items-center rounded-lg bg-red-500 p-3 w-40 h-14 text-white hover:bg-red-600 transition-colors">
                                <FaPencilAlt />
                                Editar Perfil
                            </button>
                        </div>
