    ...
    return (
        ...
        {isOpen &&
            <Modal>
                ...
                <form onSubmit={handleSubmit(handleCreateNewProduct)} encType="multipart/form-data" className="grid gap-5 grid-cols-1 place-items-center mt-5">
                    ...
                    <button type="submit" className="p-3 w-full rounded-lg text-xl bg-red-500 text-white hover:bg-red-600 transition-colors lg:h-12 sm: h-[50px]">Criar produto</button>
                </form>
            </Modal>
        }
        </>
