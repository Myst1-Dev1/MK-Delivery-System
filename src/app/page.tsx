  ...
  return (
    <div className='mt-16 container px-3 m-auto'>
      ...
      <div className='flex justify-end items-end gap-5 py-10 mb-20'>
        <button className='p-3 rounded-lg w-10 h-10 border bg-gray-500 text-white flex justify-center items-center hover:bg-red-600 transition-color'>1</button>
        <button className='p-3 rounded-lg w-10 h-10 border bg-gray-500 text-white flex justify-center items-center hover:bg-red-600 transition-color'>2</button>
        <button className='p-3 rounded-lg w-10 h-10 border bg-gray-500 text-white flex justify-center items-center hover:bg-red-600 transition-color'>3</button>
      </div>
    </div>
  )
}
